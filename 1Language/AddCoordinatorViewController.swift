    ...
    @IBAction func registerUser() {
        ...
        if (!Reachability.isConnectedToNetwork()) {
            ...
            if (middlenameField.text?.characters.count > 0) {
                ...
                appData = "accountType=coordinator&firstname=\(firstnamefield.text!)&middlename=\(middlenameField.text!)&lastname=\(lastnameField.text!)&email=\(emailField.text!)&username=\(usernameField.text!)&password=\(passwordField.text!)&department=\(departmentField.text!)"
                
            } else {
                
                appData = "accountType=coordinator&firstname=\(firstnamefield.text!)&lastname=\(lastnameField.text!)&email=\(emailField.text!)&username=\(usernameField.text!)&password=\(passwordField.text!)&department=\(departmentField.text!)"
            }
