...
class AddManagerViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        if (!Reachability.isConnectedToNetwork()) {
            ...
            //  picker data
            NSNotificationCenter.defaultCenter().addObserver(self, selector: (#selector(AddManagerViewController.updatePicker)), name: UITextFieldTextDidBeginEditingNotification, object: nil)
            
            //Tap gesture to hide keyboard or input
            let tap: UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(AddManagerViewController.dismissKeyboard))
